...
{    
 ...
 // ***************** Resreve Fleet Ships ************************   
     ...
     * if ship not found, "Not available" if ship is not in the reserve fleet, 
    ...
    /** Removes a ship from the squadron to the fleet,if they are in the squadron
...
//**********************Encounters************************* 
     ...
     * @return true if the number represents a encounter, else false
     **/
